...
```
npm create cloudflare@latest -- --template=cloudflare/templates/public-access-test
```

A live public deployment of this template is available at [https://public-access-test.templates.workers.dev](https://public-access-test.templates.workers.dev)
